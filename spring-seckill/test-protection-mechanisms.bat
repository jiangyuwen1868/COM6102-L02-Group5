...
set PRODUCT_ID=1
set USER_ID=349
set TOKEN=eyJhbGciOiJIUzI1NiJ9.eyJ1c2VySWQiOjM0OSwidXNlcm5hbWUiOiJ0ZXN0IiwiZXhwIjoxNzgwNjk3NDQ0LCJpYXQiOjE3ODA2NjE0NDR9.6k7iO2eFd4pK6cFgF3h3v7v7v7v7v7v7v7v7v7v7v7v7v7
